 ...
 * 요약하면 이 엔드포인트가 주는 가격은 productPrice 하나뿐이고, 그 값이
 * 어떤 종류의 가격인지(정가·즉시할인가·쿠폰적용가) 응답에 표시가 없다.
 * ★ 2026-09-04 실측으로 이 값이 상품 페이지 가격과 다른 사례가 확인됐다
 *   (7912306911: API 22,320원 ↔ 페이지 26,900원). "판매가" 라고 단정하지 말 것.
 *
