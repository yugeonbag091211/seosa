...
const CASES = [
  ...
  ['20만원 이하 통화 좋은 이어폰', 'C', '통화 품질+예산'],
  ['아이폰17 지금 사도 돼?', 'E', '출시 제품 구매 시점'],
  ['대학생 노트북 100만원 이하', 'C', '대상+예산'],
  ['에어팟 프로 vs 버즈', 'A', '상품 비교'],
  ['가성비 무선청소기', 'C', '가성비 추천'],
  ['그중 가장 싼 거', 'C', '최저가 후속'],
  ['배터리를 제일 중요하게 봐', 'C', '우선순위 후속'],
  ['아버지 생신 선물로 10만원 이하 골프용품', 'C', '선물+예산'],
  ['비싸도 괜찮으니 가장 가벼운 노트북', 'C', '품질+휴대성'],
  ['리뷰 데이터 없으면 모른다고 말해줘', 'B', '데이터 부족'],
  ['이 가격이 역대 최저가야?', 'D', '가격 이력'],
  ['한 달 기다리면 더 싸질까?', 'E', '구매 시점 예측'],
  ['둘 중 게임용으로 더 나은 건?', 'A', '용도 비교 후속'],
  ['배송 빠른 것만 보여줘', 'C', '배송 조건'],
  ['중고 말고 새 제품만', 'C', '제외 조건'],
  ['예산은 없는데 후회 적은 걸로', 'C', '모호한 예산'],
  ['가격 정보가 없는 상품도 추천해?', 'B', '정책 질문'],
  ['맥북 사려는데 뭐가 좋아?', 'C', '애매한 추천']
];
